...
$lang = array_merge($lang, array(
	...
	'QUICK_STYLE_PERMISSION_EXPLAIN'	=> 'Η πρόσβαση στον επιλογέα στυλ ελέγχεται μέσω του δικαιώματος <strong>Μπορεί να χρησιμοποιήσει το Quick Style</strong>. Ρυθμίστε το στη Διαχείριση &raquo; Δικαιώματα &raquo; Δικαιώματα χρηστών ή ομάδων.',
