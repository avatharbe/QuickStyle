...
$lang = array_merge($lang, array(
	...
	'QUICK_STYLE_PERMISSION_EXPLAIN'	=> 'Доступ к переключателю стилей контролируется правом <strong>Может использовать Quick Style</strong>. Настройте его в Администрирование &raquo; Права доступа &raquo; Права пользователей или групп.',
